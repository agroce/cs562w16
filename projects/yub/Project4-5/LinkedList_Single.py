...
if __name__ == '__main__':
    ...
    # alist.insert(3)
    # alist.insert(5)
    print alist.returnIndex(2)
    print "====="
    # for data_2 in [2,3,4,5]:
    # alist.updateIndex(5,3)
    # print alist.printFirstValue()
    # alist.deleteIndex(3)
    print alist.seach_Index_Value(3)
    print
    # print alist.returnIndex(3)
