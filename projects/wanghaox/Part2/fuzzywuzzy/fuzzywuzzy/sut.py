...
class sut(object):
    ...
    def act114(self):
        self.__test.append(('''self.p_stringA[0] = self.p_string[0] ''',self.guard114,self.act114))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            self.p_stringA[0] = self.p_string[0]
            ...
            if self.__collectCov:
                self.__cov.stop()
                self.__updateCov()
        self.p_stringA_used[0]=False
    def guard114(self):
        return (((self.p_stringA_used[0]) or (self.p_stringA[0] == None) or (self.__relaxUsedRestriction))) and (self.p_string[0] != None)
    
    def act115(self):
        self.__test.append(('''self.p_stringA[0] = self.p_string[1] ''',self.guard115,self.act115))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            self.p_stringA[0] = self.p_string[1]
        ...
        self.p_stringA_used[0]=False
    def guard115(self):
        return (((self.p_stringA_used[0]) or (self.p_stringA[0] == None) or (self.__relaxUsedRestriction))) and (self.p_string[1] != None)
    
    def act116(self):
        self.__test.append(('''self.p_stringB[0] = self.p_string[0] ''',self.guard116,self.act116))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            self.p_stringB[0] = self.p_string[0]
            ...
            if self.__collectCov:
                self.__cov.stop()
                self.__updateCov()
        self.p_stringB_used[0]=False
    def guard116(self):
        return (((self.p_stringB_used[0]) or (self.p_stringB[0] == None) or (self.__relaxUsedRestriction))) and (self.p_string[0] != None)
    
    def act117(self):
        self.__test.append(('''self.p_stringB[0] = self.p_string[1] ''',self.guard117,self.act117))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            self.p_stringB[0] = self.p_string[1]
        ...
        self.p_stringB_used[0]=False
    def guard117(self):
        return (((self.p_stringB_used[0]) or (self.p_stringB[0] == None) or (self.__relaxUsedRestriction))) and (self.p_string[1] != None)
    
    def act118(self):
        self.__test.append(('''print "String #1:", self.p_stringA[0] ''',self.guard118,self.act118))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            print "String #1:", self.p_stringA[0]
            ...
            if self.__collectCov:
                self.__cov.stop()
                self.__updateCov()
        self.p_stringA_used[0]=True
    def guard118(self):
        return (self.p_stringA[0] != None)
    
    def act119(self):
        self.__test.append(('''print "String #2:", self.p_stringB[0] ''',self.guard119,self.act119))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            print "String #2:", self.p_stringB[0]
            ...
            if self.__collectCov:
                self.__cov.stop()
                self.__updateCov()
        self.p_stringB_used[0]=True
    def guard119(self):
        return (self.p_stringB[0] != None)
    
    def act120(self):
        self.__test.append(('''print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0]) ''',self.guard120,self.act120))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0])
        ...
        self.p_stringA_used[0]=True
    def guard120(self):
        return (self.p_stringB[0] != None) and (self.p_stringA[0] != None)
    
    def act121(self):
        self.__test.append(('''print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0]) ''',self.guard121,self.act121))
        if self.__collectCov:
            self.__cov.start()
        try:
            test_before_each(self)
            ...
            pass
        try:
            print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0])
    ...
    def __init__(self):
        ...
        self.p_stringB = {}
        self.p_stringB_used = {}
        self.__psize["stringB"] = 1
        self.__pools.append("self.p_stringB")
        self.p_stringB[0] = None
        self.p_stringB_used[0] = True
        self.p_stringB[1] = None
        self.p_stringB_used[1] = True
        self.p_stringA = {}
        self.p_stringA_used = {}
        self.__psize["stringA"] = 1
        self.__pools.append("self.p_stringA")
        self.p_stringA[0] = None
        self.p_stringA_used[0] = True
        self.p_stringA[1] = None
        self.p_stringA_used[1] = True
        self.p_string = {}
        self.p_string_used = {}
    ...
    # END INITIALIZATION CODE
        ...
        self.__actions.append(('''self.p_stringA[0] = self.p_string[0] ''',self.guard114,self.act114))

        self.__names['''self.p_stringA[0] = self.p_string[0] '''] = ('''self.p_stringA[0] = self.p_string[0] ''',self.guard114,self.act114)

        self.__orderings['''self.p_stringA[0] = self.p_string[0] '''] = 115

        self.__okExcepts['''self.p_stringA[0] = self.p_string[0] '''] = ''''''

        self.__actions.append(('''self.p_stringA[0] = self.p_string[1] ''',self.guard115,self.act115))

        self.__names['''self.p_stringA[0] = self.p_string[1] '''] = ('''self.p_stringA[0] = self.p_string[1] ''',self.guard115,self.act115)

        self.__orderings['''self.p_stringA[0] = self.p_string[1] '''] = 116

        self.__okExcepts['''self.p_stringA[0] = self.p_string[1] '''] = ''''''

        self.__actions.append(('''self.p_stringB[0] = self.p_string[0] ''',self.guard116,self.act116))

        self.__names['''self.p_stringB[0] = self.p_string[0] '''] = ('''self.p_stringB[0] = self.p_string[0] ''',self.guard116,self.act116)

        self.__orderings['''self.p_stringB[0] = self.p_string[0] '''] = 117

        self.__okExcepts['''self.p_stringB[0] = self.p_string[0] '''] = ''''''

        self.__actions.append(('''self.p_stringB[0] = self.p_string[1] ''',self.guard117,self.act117))

        self.__names['''self.p_stringB[0] = self.p_string[1] '''] = ('''self.p_stringB[0] = self.p_string[1] ''',self.guard117,self.act117)

        self.__orderings['''self.p_stringB[0] = self.p_string[1] '''] = 118

        self.__okExcepts['''self.p_stringB[0] = self.p_string[1] '''] = ''''''

        self.__actions.append(('''print "String #1:", self.p_stringA[0] ''',self.guard118,self.act118))

        self.__names['''print "String #1:", self.p_stringA[0] '''] = ('''print "String #1:", self.p_stringA[0] ''',self.guard118,self.act118)

        self.__orderings['''print "String #1:", self.p_stringA[0] '''] = 119

        self.__okExcepts['''print "String #1:", self.p_stringA[0] '''] = ''''''

        self.__actions.append(('''print "String #2:", self.p_stringB[0] ''',self.guard119,self.act119))

        self.__names['''print "String #2:", self.p_stringB[0] '''] = ('''print "String #2:", self.p_stringB[0] ''',self.guard119,self.act119)

        self.__orderings['''print "String #2:", self.p_stringB[0] '''] = 120

        self.__okExcepts['''print "String #2:", self.p_stringB[0] '''] = ''''''

        self.__actions.append(('''print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0]) ''',self.guard120,self.act120))

        self.__names['''print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0]) '''] = ('''print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0]) ''',self.guard120,self.act120)

        self.__orderings['''print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0]) '''] = 121

        self.__okExcepts['''print "Result for Ratio =", fuzz.ratio(self.p_stringA[0],self.p_stringB[0]) '''] = ''''''

        self.__actions.append(('''print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0]) ''',self.guard121,self.act121))

        self.__names['''print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0]) '''] = ('''print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0]) ''',self.guard121,self.act121)

        self.__orderings['''print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0]) '''] = 122

        self.__okExcepts['''print "Result for Partial Ratio =", fuzz.partial_ratio(self.p_stringA[0],self.p_stringB[0]) '''] = ''''''
    ...
    def state(self):
        ...
        return [ copy.deepcopy(self.p_char),copy.deepcopy(self.p_char_used),copy.deepcopy(self.p_stringB),copy.deepcopy(self.p_stringB_used),copy.deepcopy(self.p_stringA),copy.deepcopy(self.p_stringA_used),copy.deepcopy(self.p_string),copy.deepcopy(self.p_string_used)]
    def backtrack(self,old):
        ...
        self.p_stringB = copy.deepcopy(old[2])
        self.p_stringB_used = copy.deepcopy(old[3])
        self.p_stringA = copy.deepcopy(old[4])
        self.p_stringA_used = copy.deepcopy(old[5])
