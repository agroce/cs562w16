...
class sut(object):
    def act0(self):
        self.__test.append(('''self.p_word[0] = u"成都"
 ''',self.guard0,self.act0))
        try:
            ...
            try:
                ...
                pass
        self.p_word_used[0]=False
    def guard0(self):
        return (((self.p_word_used[0]) or (self.p_word[0] == None) or (self.__relaxUsedRestriction)))
    
    def act1(self):
        self.__test.append(('''self.p_word[0] = u"广州"
 ''',self.guard1,self.act1))
    ...
    def act2(self):
        self.__test.append(('''self.p_word[1] = u"成都"
 ''',self.guard2,self.act2))
        try:
            ...
            try:
                ...
                pass
        self.p_word_used[1]=False
    def guard2(self):
        return (((self.p_word_used[1]) or (self.p_word[1] == None) or (self.__relaxUsedRestriction)))
    
    def act3(self):
        self.__test.append(('''self.p_word[1] = u"广州"
 ''',self.guard3,self.act3))
    ...
    def act4(self):
        self.__test.append(('''self.p_word[2] = u"成都"
 ''',self.guard4,self.act4))
        try:
            ...
            try:
                ...
                pass
        self.p_word_used[2]=False
    def guard4(self):
        return (((self.p_word_used[2]) or (self.p_word[2] == None) or (self.__relaxUsedRestriction)))
    
    def act5(self):
        self.__test.append(('''self.p_word[2] = u"广州"
 ''',self.guard5,self.act5))
    ...
    def act6(self):
        self.__test.append(('''self.p_word[3] = u"成都"
 ''',self.guard6,self.act6))
        try:
            ...
            try:
                ...
                pass
        self.p_word_used[3]=False
    def guard6(self):
        return (((self.p_word_used[3]) or (self.p_word[3] == None) or (self.__relaxUsedRestriction)))
    
    def act7(self):
        self.__test.append(('''self.p_word[3] = u"广州"
 ''',self.guard7,self.act7))
    ...
    def act8(self):
        self.__test.append(('''self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard8,self.act8))
        try:
            self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
    ...
    def act9(self):
        self.__test.append(('''self.p_word[0] = u"干支体系呢"
 ''',self.guard9,self.act9))
        try:
            self.p_word[0] = u"干支体系呢"
    ...
    def act10(self):
        self.__test.append(('''self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard10,self.act10))
        try:
            self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
    ...
    def act11(self):
        self.__test.append(('''self.p_word[1] = u"干支体系呢"
 ''',self.guard11,self.act11))
        try:
            self.p_word[1] = u"干支体系呢"
    ...
    def act12(self):
        self.__test.append(('''self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard12,self.act12))
        try:
            self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
    ...
    def act13(self):
        self.__test.append(('''self.p_word[2] = u"干支体系呢"
 ''',self.guard13,self.act13))
        try:
            self.p_word[2] = u"干支体系呢"
    ...
    def act14(self):
        self.__test.append(('''self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard14,self.act14))
        try:
            self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
    ...
    def act15(self):
        self.__test.append(('''self.p_word[3] = u"干支体系呢"
 ''',self.guard15,self.act15))
        try:
            self.p_word[3] = u"干支体系呢"
 ...
 ''',self.guard16,self.act16))
    ...
    def act17(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[0])
 ''',self.guard17,self.act17))
        try:
            print self.p_w[0].get_pinyin(self.p_word[0])
            ...
            try:
                ...
                pass
        self.p_word_used[0]=True
        self.p_w_used[0]=True
    def guard17(self):
        return (self.p_word[0] != None) and (self.p_w[0] != None)
    
    def act18(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[1])
 ''',self.guard18,self.act18))
        try:
            print self.p_w[0].get_pinyin(self.p_word[1])
            ...
            try:
                ...
                pass
        self.p_word_used[1]=True
        self.p_w_used[0]=True
    def guard18(self):
        return (self.p_word[1] != None) and (self.p_w[0] != None)
    
    def act19(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[2])
 ''',self.guard19,self.act19))
        try:
            print self.p_w[0].get_pinyin(self.p_word[2])
            ...
            try:
                ...
                pass
        self.p_word_used[2]=True
        self.p_w_used[0]=True
    def guard19(self):
        return (self.p_word[2] != None) and (self.p_w[0] != None)
    
    def act20(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[3])
 ''',self.guard20,self.act20))
        try:
            print self.p_w[0].get_pinyin(self.p_word[3])
            ...
            try:
                ...
                pass
        self.p_word_used[3]=True
        self.p_w_used[0]=True
    def guard20(self):
        return (self.p_word[3] != None) and (self.p_w[0] != None)
    
    def act21(self):
        self.__test.append(('''print self.p_w[0].get_initials(self.p_word[0])
 ''',self.guard21,self.act21))
        try:
            print self.p_w[0].get_initials(self.p_word[0])
    ...
    def act22(self):
        self.__test.append(('''print self.p_w[0].get_initials(self.p_word[1])
 ''',self.guard22,self.act22))
        try:
            print self.p_w[0].get_initials(self.p_word[1])
    ...
    def act23(self):
        self.__test.append(('''print self.p_w[0].get_initials(self.p_word[2])
 ''',self.guard23,self.act23))
        try:
            print self.p_w[0].get_initials(self.p_word[2])
    ...
    def act24(self):
        self.__test.append(('''print self.p_w[0].get_initials(self.p_word[3])
 ''',self.guard24,self.act24))
        try:
            print self.p_w[0].get_initials(self.p_word[3])
    ...
    def act25(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
 ''',self.guard25,self.act25))
        try:
            print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
    ...
    def act26(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
 ''',self.guard26,self.act26))
        try:
            print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
    ...
    def act27(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
 ''',self.guard27,self.act27))
        try:
            print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
    ...
    def act28(self):
        self.__test.append(('''print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 ''',self.guard28,self.act28))
        try:
            print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 ...
 ''',self.guard32,self.act32))
    ...
    def __init__(self):
        ...
        self.p_word_used = {}
        self.__psize["word"] = 4
        self.__pools.append("self.p_word")
        self.p_word[0] = None
        self.p_word_used[0] = True
        self.p_word[1] = None
        self.p_word_used[1] = True
    ...
    # END INITIALIZATION CODE
        ...
        self.__actions.append(('''self.p_word[0] = u"成都"
 ''',self.guard0,self.act0))

        self.__names['''self.p_word[0] = u"成都"
 '''] = ('''self.p_word[0] = u"成都"
 ''',self.guard0,self.act0)

        self.__orderings['''self.p_word[0] = u"成都"
 '''] = 1

        self.__okExcepts['''self.p_word[0] = u"成都"
 '''] = ''''''

        self.__actions.append(('''self.p_word[0] = u"广州"
 ''',self.guard1,self.act1))

        self.__names['''self.p_word[0] = u"广州"
 '''] = ('''self.p_word[0] = u"广州"
 ''',self.guard1,self.act1)

        self.__orderings['''self.p_word[0] = u"广州"
 '''] = 2

        self.__okExcepts['''self.p_word[0] = u"广州"
 '''] = ''''''

        self.__actions.append(('''self.p_word[1] = u"成都"
 ''',self.guard2,self.act2))

        self.__names['''self.p_word[1] = u"成都"
 '''] = ('''self.p_word[1] = u"成都"
 ''',self.guard2,self.act2)

        self.__orderings['''self.p_word[1] = u"成都"
 '''] = 3

        self.__okExcepts['''self.p_word[1] = u"成都"
 '''] = ''''''

        self.__actions.append(('''self.p_word[1] = u"广州"
 ''',self.guard3,self.act3))

        self.__names['''self.p_word[1] = u"广州"
 '''] = ('''self.p_word[1] = u"广州"
 ''',self.guard3,self.act3)

        self.__orderings['''self.p_word[1] = u"广州"
 '''] = 4

        self.__okExcepts['''self.p_word[1] = u"广州"
 '''] = ''''''

        self.__actions.append(('''self.p_word[2] = u"成都"
 ''',self.guard4,self.act4))

        self.__names['''self.p_word[2] = u"成都"
 '''] = ('''self.p_word[2] = u"成都"
 ''',self.guard4,self.act4)

        self.__orderings['''self.p_word[2] = u"成都"
 '''] = 5

        self.__okExcepts['''self.p_word[2] = u"成都"
 '''] = ''''''

        self.__actions.append(('''self.p_word[2] = u"广州"
 ''',self.guard5,self.act5))

        self.__names['''self.p_word[2] = u"广州"
 '''] = ('''self.p_word[2] = u"广州"
 ''',self.guard5,self.act5)

        self.__orderings['''self.p_word[2] = u"广州"
 '''] = 6

        self.__okExcepts['''self.p_word[2] = u"广州"
 '''] = ''''''

        self.__actions.append(('''self.p_word[3] = u"成都"
 ''',self.guard6,self.act6))

        self.__names['''self.p_word[3] = u"成都"
 '''] = ('''self.p_word[3] = u"成都"
 ''',self.guard6,self.act6)

        self.__orderings['''self.p_word[3] = u"成都"
 '''] = 7

        self.__okExcepts['''self.p_word[3] = u"成都"
 '''] = ''''''

        self.__actions.append(('''self.p_word[3] = u"广州"
 ''',self.guard7,self.act7))

        self.__names['''self.p_word[3] = u"广州"
 '''] = ('''self.p_word[3] = u"广州"
 ''',self.guard7,self.act7)

        self.__orderings['''self.p_word[3] = u"广州"
 '''] = 8

        self.__okExcepts['''self.p_word[3] = u"广州"
 '''] = ''''''

        self.__actions.append(('''self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard8,self.act8))

        self.__names['''self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ('''self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard8,self.act8)

        self.__orderings['''self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = 9

        self.__okExcepts['''self.p_word[0] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ''''''

        self.__actions.append(('''self.p_word[0] = u"干支体系呢"
 ''',self.guard9,self.act9))

        self.__names['''self.p_word[0] = u"干支体系呢"
 '''] = ('''self.p_word[0] = u"干支体系呢"
 ''',self.guard9,self.act9)

        self.__orderings['''self.p_word[0] = u"干支体系呢"
 '''] = 10

        self.__okExcepts['''self.p_word[0] = u"干支体系呢"
 '''] = ''''''

        self.__actions.append(('''self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard10,self.act10))

        self.__names['''self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ('''self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard10,self.act10)

        self.__orderings['''self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = 11

        self.__okExcepts['''self.p_word[1] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ''''''

        self.__actions.append(('''self.p_word[1] = u"干支体系呢"
 ''',self.guard11,self.act11))

        self.__names['''self.p_word[1] = u"干支体系呢"
 '''] = ('''self.p_word[1] = u"干支体系呢"
 ''',self.guard11,self.act11)

        self.__orderings['''self.p_word[1] = u"干支体系呢"
 '''] = 12

        self.__okExcepts['''self.p_word[1] = u"干支体系呢"
 '''] = ''''''

        self.__actions.append(('''self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard12,self.act12))

        self.__names['''self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ('''self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard12,self.act12)

        self.__orderings['''self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = 13

        self.__okExcepts['''self.p_word[2] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ''''''

        self.__actions.append(('''self.p_word[2] = u"干支体系呢"
 ''',self.guard13,self.act13))

        self.__names['''self.p_word[2] = u"干支体系呢"
 '''] = ('''self.p_word[2] = u"干支体系呢"
 ''',self.guard13,self.act13)

        self.__orderings['''self.p_word[2] = u"干支体系呢"
 '''] = 14

        self.__okExcepts['''self.p_word[2] = u"干支体系呢"
 '''] = ''''''

        self.__actions.append(('''self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard14,self.act14))

        self.__names['''self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ('''self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 ''',self.guard14,self.act14)

        self.__orderings['''self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = 15

        self.__okExcepts['''self.p_word[3] = u"值得注意的是，本书使用了一套“古怪”的计时术语作为全书的时间框架体系，如“阏逄摄提格之岁”之类。“阏逄”相当于汉语“甲”，“摄提格”相当于汉语“寅”。为什么不用汉语的天干地支，而偏偏要用一套多音节语言的干支体系呢？司马光没有交代。"
 '''] = ''''''

        self.__actions.append(('''self.p_word[3] = u"干支体系呢"
 ''',self.guard15,self.act15))

        self.__names['''self.p_word[3] = u"干支体系呢"
 '''] = ('''self.p_word[3] = u"干支体系呢"
 ''',self.guard15,self.act15)

        self.__orderings['''self.p_word[3] = u"干支体系呢"
 '''] = 16

        self.__okExcepts['''self.p_word[3] = u"干支体系呢"
 '''] = ''''''
 ...
 '''] = ''''''
        ...
        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[0])
 ''',self.guard17,self.act17))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[0])
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[0])
 ''',self.guard17,self.act17)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[0])
 '''] = 18

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[0])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[1])
 ''',self.guard18,self.act18))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[1])
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[1])
 ''',self.guard18,self.act18)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[1])
 '''] = 19

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[1])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[2])
 ''',self.guard19,self.act19))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[2])
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[2])
 ''',self.guard19,self.act19)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[2])
 '''] = 20

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[2])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[3])
 ''',self.guard20,self.act20))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[3])
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[3])
 ''',self.guard20,self.act20)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[3])
 '''] = 21

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[3])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_initials(self.p_word[0])
 ''',self.guard21,self.act21))

        self.__names['''print self.p_w[0].get_initials(self.p_word[0])
 '''] = ('''print self.p_w[0].get_initials(self.p_word[0])
 ''',self.guard21,self.act21)

        self.__orderings['''print self.p_w[0].get_initials(self.p_word[0])
 '''] = 22

        self.__okExcepts['''print self.p_w[0].get_initials(self.p_word[0])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_initials(self.p_word[1])
 ''',self.guard22,self.act22))

        self.__names['''print self.p_w[0].get_initials(self.p_word[1])
 '''] = ('''print self.p_w[0].get_initials(self.p_word[1])
 ''',self.guard22,self.act22)

        self.__orderings['''print self.p_w[0].get_initials(self.p_word[1])
 '''] = 23

        self.__okExcepts['''print self.p_w[0].get_initials(self.p_word[1])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_initials(self.p_word[2])
 ''',self.guard23,self.act23))

        self.__names['''print self.p_w[0].get_initials(self.p_word[2])
 '''] = ('''print self.p_w[0].get_initials(self.p_word[2])
 ''',self.guard23,self.act23)

        self.__orderings['''print self.p_w[0].get_initials(self.p_word[2])
 '''] = 24

        self.__okExcepts['''print self.p_w[0].get_initials(self.p_word[2])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_initials(self.p_word[3])
 ''',self.guard24,self.act24))

        self.__names['''print self.p_w[0].get_initials(self.p_word[3])
 '''] = ('''print self.p_w[0].get_initials(self.p_word[3])
 ''',self.guard24,self.act24)

        self.__orderings['''print self.p_w[0].get_initials(self.p_word[3])
 '''] = 25

        self.__okExcepts['''print self.p_w[0].get_initials(self.p_word[3])
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
 ''',self.guard25,self.act25))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
 ''',self.guard25,self.act25)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
 '''] = 26

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[0], show_tone_marks=True)
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
 ''',self.guard26,self.act26))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
 ''',self.guard26,self.act26)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
 '''] = 27

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[1], show_tone_marks=True)
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
 ''',self.guard27,self.act27))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
 ''',self.guard27,self.act27)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
 '''] = 28

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[2], show_tone_marks=True)
 '''] = ''''''

        self.__actions.append(('''print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 ''',self.guard28,self.act28))

        self.__names['''print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 '''] = ('''print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 ''',self.guard28,self.act28)

        self.__orderings['''print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 '''] = 29

        self.__okExcepts['''print self.p_w[0].get_pinyin(self.p_word[3], show_tone_marks=True)
 '''] = ''''''
 ...
 '''] = ''''''
    ...
    def state(self):
        ...
        return [ copy.deepcopy(self.p_word),copy.deepcopy(self.p_word_used),copy.deepcopy(self.p_w),copy.deepcopy(self.p_w_used)]
    def backtrack(self,old):
        if self.__replayBacktrack:
            self.replay(self.replayable(old))
            return
        self.p_word = copy.deepcopy(old[0])
        self.p_word_used = copy.deepcopy(old[1])
        self.p_w = copy.deepcopy(old[2])
        self.p_w_used = copy.deepcopy(old[3])
    def check(self):
        return True
    """
